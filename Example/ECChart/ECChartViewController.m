...
{
    /*     Create object        */
    ECLineChart *lineChart = [[ECLineChart alloc] initWithFrame:CGRectMake(10, 100, k_MainBoundsWidth-20, 300) andLineChartType:ECChartLineValueNotForEveryX];
    ...
    lineChart.lineChartQuadrantType = ECLineChartQuadrantTypeFirstQuardrant;
...
- (void)showFirstAndSecondQuardrant
{
    ...
    lineChart.lineChartQuadrantType = ECLineChartQuadrantTypeFirstAndSecondQuardrant;
...
- (void)showFirstAndFouthQuardrant
{
    ECLineChart *lineChart = [[ECLineChart alloc] initWithFrame:CGRectMake(10, 100, k_MainBoundsWidth-20, 300) andLineChartType:ECChartLineValueNotForEveryX];
    lineChart.xLineDataArr = @[@"0",@"1",@"2",@3,@4,@5,@6,@7];
    lineChart.lineChartQuadrantType = ECLineChartQuadrantTypeFirstAndFouthQuardrant;
...
- (void)showAllQuardrant
{
    ...
    lineChart.xLineDataArr = @[@[@"-3",@"-2",@"-1"],@[@0,@1,@2,@3]];
    lineChart.lineChartQuadrantType = ECLineChartQuadrantTypeAllQuardrant;
...
{
    ECPieChart *pie = [[ECPieChart alloc] initWithFrame:CGRectMake(100, 100, 321, 421)];
...
{
    ECRingChart *ring = [[ECRingChart alloc] initWithFrame:CGRectMake(0, 100, k_MainBoundsWidth, k_MainBoundsWidth)];
    /*        background color         */
...
- (void)showColumnView
{
    ECColumnChart *column = [[ECColumnChart alloc] initWithFrame:CGRectMake(0, 100, k_MainBoundsWidth, k_MainBoundsWidth)];
...
- (void)showTableView
{
    ECTableChart *table = [[ECTableChart alloc] initWithFrame:CGRectMake(10, 64, k_MainBoundsWidth-20, k_MainBoundsHeight)];
    /*       Table name         */
...
- (void)showRadarChartView
{
    ...
    ECRadarChart *radarChart = [[ECRadarChart alloc] initWithFrame:CGRectMake(10, 74, k_MainBoundsWidth - 20, k_MainBoundsWidth - 20)];

...
#import "ECTableChart.h"
#import "ECTableDataRowModel.h"

@interface ECTableChart ()
...
- (void)setDataArr:(NSArray *)dataArr
{
    ...
    for (NSInteger i = 0; i<_dataArr.count; i++) {
        ...
        ECTableDataRowModel *model = [ECTableDataRowModel new];
        model.maxCount = 1;
...
- (void)drawRect:(CGRect)rect
{
    ...
    for (NSInteger i = 0; i<_dataModelArr.count; i++) {
        ...
        ECTableDataRowModel *model = _dataModelArr[i];

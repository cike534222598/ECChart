...
#import "ECWaveChart.h"

@interface ECWaveChart()

@property (nonatomic,strong) NSArray * yLineDataArr;
@property (assign , nonatomic) ECWaveChartType  waveChartType ;

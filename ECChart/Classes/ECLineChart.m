...
#import "ECLineChart.h"

#define kXandYSpaceForSuperView 20.0

@interface ECLineChart ()
 ...
 *  @return 自定义折线图
 */
- (instancetype)initWithFrame:(CGRect)frame andLineChartType:(ECLineChartType)lineChartType
{
...
- (void)configPerXAndPerY
{
    ...
    switch (_lineChartQuadrantType) {
        case ECLineChartQuadrantTypeFirstQuardrant:
        {
            ...
            break;
        case ECLineChartQuadrantTypeFirstAndSecondQuardrant:
        {
            _perXLen = (_xLength/2-kXandYSpaceForSuperView)/[_xLineDataArr[0] count];
            _perYlen = (_yLength-kXandYSpaceForSuperView)/_yLineDataArr.count;
        }
            break;
        case ECLineChartQuadrantTypeFirstAndFouthQuardrant:
        {
            _perXLen = (_xLength-kXandYSpaceForSuperView)/(_xLineDataArr.count-1);
            _perYlen = (_yLength/2-kXandYSpaceForSuperView)/[_yLineDataArr[0] count];
        }
            break;
        case ECLineChartQuadrantTypeAllQuardrant:
        {
            _perXLen = (_xLength/2-kXandYSpaceForSuperView)/([_xLineDataArr[0] count]);
            _perYlen = (_yLength/2-kXandYSpaceForSuperView)/[_yLineDataArr[0] count];
        }
 ...
 *
 */
- (void)setLineChartQuadrantType:(ECLineChartQuadrantType)lineChartQuadrantType
{
